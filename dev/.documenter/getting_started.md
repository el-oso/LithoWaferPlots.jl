...
## Step 1 — Define the wafer {#Step-1-—-Define-the-wafer}
...
## Step 2 — Load measurement data {#Step-2-—-Load-measurement-data}

### From a DataFrame (mm coordinates) {#From-a-DataFrame-mm-coordinates}
...
### From die indices {#From-die-indices}
...
## Step 4 — Add field overlays {#Step-4-—-Add-field-overlays}

Pass a `fields` vector when constructing `WaferData` to overlay rectangular exposure fields on any plot type.
...
## Step 5 — Vector field plots {#Step-5-—-Vector-field-plots}
...
See the [Gallery](/gallery#Gallery) for divergence and vorticity examples.
