...
- The extension must work with **all three backends**: CairoMakie, GLMakie, and WGLMakie. Never use backend-specific APIs (e.g., `GLMakie.activate!`, `CairoMakie.activate!`) in the extension code itself.
